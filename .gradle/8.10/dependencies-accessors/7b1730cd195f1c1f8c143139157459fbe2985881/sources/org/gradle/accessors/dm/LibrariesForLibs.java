...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class GroovyLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>all</b> with <b>org.codehaus.groovy:groovy-all</b> coordinates and
         * with version reference <b>groovy.all</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final GroovyVersionAccessors vaccForGroovyVersionAccessors = new GroovyVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.groovy</b>
         */
        public GroovyVersionAccessors getGroovy() {
            return vaccForGroovyVersionAccessors;
        }

    }

    public static class GroovyVersionAccessors extends VersionFactory  {

        public GroovyVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>groovy.all</b> with value <b>3.0.22</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAll() { return getVersion("groovy.all"); }
